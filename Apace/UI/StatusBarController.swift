...
final class StatusBarController {
    ...
    func setup(appState: AppState, onSettings: @escaping () -> Void, onQuit: @escaping () -> Void) {
        ...
        item.button?.image = NSImage(systemSymbolName: "waveform", accessibilityDescription: "Apace")
    ...
    private func buildMenu() -> NSMenu {
        ...
        // Quit
        let quit = NSMenuItem(title: "Quit Apace", action: #selector(quitClicked), keyEquivalent: "q")
        quit.target = self
        menu.addItem(quit)
    ...
    private func setIcon(_ systemName: String) {
        statusItem?.button?.image = NSImage(systemSymbolName: systemName, accessibilityDescription: "Apace")
